import '../home_page_screen/widgets/songs1_item_widget.dart';
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                decoration:
                                    AppDecoration.textstylerobotoregular181,
                                child: Text(
                                  "lbl_trial_version".tr,
                                  textAlign: TextAlign.left,
                                  style: AppStyle.textstylerobotoregular181
                                      .copyWith(
                                    fontSize: getFontSize(
                                      18,
                                    ),
                              ...
                              child: Obx(
                                () => ListView.builder(
                                  ...
                                  itemCount: controller.homePageModelObj.value
                                      .songs1ItemList.length,
                                  itemBuilder: (context, index) {
                                    Songs1ItemModel model = controller
                                        .homePageModelObj
                                        .value
                                        .songs1ItemList[index];
                                    return Songs1ItemWidget(
                                      model,
                                    );
                                  },
                                ),
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: SvgPicture.asset(
                                      ImageConstant.imgFavoritesicon11,
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                ),
